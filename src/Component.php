    ...
    public static function create_feature(?WP_Query $query = null, array $args = []): void
    {
        ...
        if ($query->have_posts()) {
            ...
            while ($query->have_posts()) {
                ...
                echo '<div class="bg-white p-4 items-center text-center">';
                ...
                echo '<a href="'. get_permalink() .'"><h2 class="block text-xl font-bold mb-2 p-4 bg-sky-700 w-full text-white">' . get_the_title() . '</h2></a>';
