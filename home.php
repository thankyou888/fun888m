          ...
          <?php if (have_posts()): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <?php while (have_posts()): the_post(); ?>
                ...
                <article class="md:col-span-3 bg-white p-4 rounded shadow-md" itemscope itemtype="https://schema.org/Article">
                    <div class="entry-image relative">
                        <a href="<?php the_permalink(); ?>" itemprop="url">
                            <?php echo get_the_post_thumbnail(get_the_ID(), 'large', ['class' => 'w-full h-auto object-cover', 'loading' => 'lazy' , 'itemprop' => 'image']); ?>
                        </a>
                  ...
                  <?php else : ?>
                    <article class=" bg-white p-4 rounded shadow-md" itemscope itemtype="https://schema.org/Article">
                      <div class="entry-image relative">
                          ...
                          <?php $catagory = get_the_category(get_the_ID()); ?>
                          <div class="badge rounded-full badge-accent top-[-0.7rem] left-[-0.7rem] absolute text-xs">
                              <a href="<?php echo esc_url(get_category_link($catagory[0]->term_id)); ?>"><?php echo esc_html($catagory[0]->name); ?></a>
